...
if ((!empty($logoPosition['MerchantConfiguration']['logo_position']) && $logoPosition['MerchantConfiguration']['logo_position'] == 1) || (empty($logoPosition['MerchantConfiguration']['logo_position']))) {//TOP
    ?>
