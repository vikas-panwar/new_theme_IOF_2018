    ...
    <ul class="nav navbar-nav side-nav">
        ...
        <?php if ($hqStorePayments == 1) { ?> 
            ...
            <li>
                ...
                <?php
                $aClass10 = "";
                if (($this->params['controller'] == 'hq') && ($this->params['action'] == 'PaymentList' || $this->params['action'] == 'addStorePayment' || $this->params['action'] == 'storePaymentList' || $this->params['action'] == 'storeList' )) {
                    $aClass10 = "in";
                }
                ?>
                <ul id="demo10" class="collapse <?php echo $aClass10; ?>">
                    ...
                    <li<?php
                    if ($this->params['controller'] == 'hq' && ($this->params['action'] == 'storePaymentList' || $this->params['action'] == 'storeList')) {
                        echo " class=lActive";
                    }
                    ?>>
