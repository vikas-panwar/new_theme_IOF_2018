<div class="modal-dialog clearfix">
    ...
    <div class="product-detail clearfix">
        <?php foreach ($getOffer['OfferDetail'] as $off) { ?>
                        <!-- <h3><span><?php //echo "$" . number_format($default_price, 2);       ?></span></h3> -->
        ...
        <div class="product-detail-btn">
            <div class="row">
                <div class="col-lg-6 col-sm-6 col-xs-6">
                    <?php echo $this->Form->button('Continue', array('id' => 'continue', 'type' => 'button', 'class' => 'd-access-guest confirm-btn theme-bg-1')); ?>
                </div>
                <div class="col-lg-6 col-sm-6 col-xs-6">
