...
<?php } ?>
    <div class="main-container">
        ...
        <div class="layout-container pages"><!-- profile -->
            <div class="layout-content-andy hc vc bgcolor_white titlemargin">
                <div class="form hc vc">
                <?php echo $this->Form->create('DeliveryAddress', array('inputDefaults' => array('label' => false, 'div' => false, 'required' => false, 'error' => false, 'legend' => false, 'autocomplete' => 'off'), 'id' => 'Deliveryaddress', 'class' => 'form-horizontal')); ?>
            <?php if ($label1 != 1) { ?>
                <div class="delivery-add-wrap-andy">
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
    <?php
    echo $this->Form->input('DeliveryAddress.zipcode', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true));
    ?>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
    <?php
    echo $this->Form->input('DeliveryAddress1.zipcode', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true));
    ?>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo $this->Form->input('DeliveryAddress2.zipcode', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true));
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
...
<?php if ($label4 != 1) { ?>
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo $this->Form->input('DeliveryAddress3.zipcode', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true));
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
...
<?php } ?>
    ...
    ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php
                            echo $this->Form->input('DeliveryAddress4.zipcode', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Zip-Code', 'maxlength' => '6', 'label' => false, 'div' => false, 'required' => true));
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    ?>
            ...
            <div class="form-group row-andy">
                        ...
                        <?php } else { ?>
                        <?php
                        echo $this->Form->button('Submit', array('type' => 'submit', 'class' => 'hc uc button f18 bgcolor_focus w260'));
                        ?>
                        <?php
                        echo $this->Form->button('Cancel', array('type' => 'button', 'onclick' => "window.location.href='/users/myDeliveryAddress/$encrypted_storeId/$encrypted_merchantId'", 'class' => 'hc uc button f18 bgcolor_default w260'));
                        ?>
                        <?php } ?>
                        </div>
            </div>
