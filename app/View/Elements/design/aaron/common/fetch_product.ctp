...
<div class="modal-dialog clearfix ps-additional-info" >
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h3 class="modal-title">ADDITIONAL INFORMATION</h3>
        </div>
        ...
        <div class="add-more">
                    ...
                    if ($productInfo['ItemType']) {
                        ...
                        foreach ($productInfo['ItemType'] as $type) {
                            if ($type['Type']['max_value'] > 0) {
                                $minmax[$type['Type']['name']][] = 'Please select min ' . $type['Type']['min_value'] . ' max ' . $type['Type']['max_value'] . ' preference';
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="select-right spinner-popup" style='display:none;'>
                                                                <div class="in-spinner-popup">
                                                                    ...
                                                                    ?>
                                                                    <button type="button" class="btn pull-right" key="<?php echo $maxVal; ?>">
                                                                    ...
                                                                    <button type="button" class="btn pull-left" key="1">
                                                                        <i aria-hidden="true" class="glyphicon glyphicon-minus-sign"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </li>
                                ...
                                <div class="check-more prefernceAndAddOns">
                                    ...
                                    <div class="add-check-list">
                                        ...
                                        foreach ($preferencearray as $preference => $subpreferencedata) {
                                            ...
                                            <div class="sub-menu-listing">
                                                <h4><?php echo $preference; ?><?php if (!empty($minmax[$preference][0])) { ?>
                                                        <em>*</em>(<?php echo $minmax[$preference][0]; ?>)
                                                    <?php } ?></h4>
                                                <div class="check-more countPreferences">
                                                    <ul class="add-check-list clearfix">
                                                        <?php
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="select-right spinner-popup" style='display:none;'>
                                                                    <div class="in-spinner-popup">
                                                                        ...
                                                                        ?>
                                                                        <button type="button" class="btn  pull-right quantity" key="<?php echo $maxVal; ?>">
                                                                            <i aria-hidden="true" class="glyphicon glyphicon-plus-sign"></i>
                                                                        </button>
                                                                            <?php echo $this->Form->input('Item.subpreference.' . $predata['id'] . '.size', array('class' => 'form-control subPreferenceSize inbox subPreferenceSize' . $predata["id"], 'value' => 1, 'label' => false, 'div' => false, 'rel' => $predata["id"])); ?>
                                                                        <button type="button" class="btn pull-left quantity" key="1">
                                                                            <i aria-hidden="true" class="glyphicon glyphicon-minus-sign"></i>
                                                                        </button>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="add-check-list">
                                ...
                                foreach ($productInfo['Topping'] as $top) {
                                    if (!empty($top['Topping'])) {
                                        $minmaxTopping = '';
                                        if ($top['max_value'] > 0) {
                                            $minmaxTopping = 'Please select min ' . $top['min_value'] . ' max ' . $top['max_value'] . ' Add-on';
                                        }
                                        ?>
                                        <div class="sub-menu-listing">
                                            <h4><?php echo $top['name']; ?><?php if (!empty($minmaxTopping)) { ?>
                                                    <em>*</em>(<?php echo $minmaxTopping; ?>)
                                                <?php } ?></h4>
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="select-right spinner-popup" style="<?php echo ($checked) ? '' : 'display:none;'; ?>">
                                                                <div class="in-spinner-popup">
                                                                    ...
                                                                    ?>
                                                                    <button type="button" class="btn  pull-right quantity" key="<?php echo $max; ?>" <?php echo $toppingSizes; ?>>
                                                                        <i aria-hidden="true" class="glyphicon glyphicon-plus-sign"></i>
                                                                    </button>
                                                                    <?php echo $this->Form->input('Item.toppings.' . $topping['id'] . '.size', array('value' => 1, 'class' => 'form-control toppingSize inbox toppingSize quantity' . $topping['id'], 'label' => false, 'div' => false, 'rel' => $topping['id'])); ?>
                                                                    <button type="button" class="btn pull-left quantity" key="0" <?php echo $toppingSizes; ?>>
                                                                        <i aria-hidden="true" class="glyphicon glyphicon-minus-sign"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
            ...
            <div class="confirm">
                <?php echo $this->Form->submit('CONFIRM', array('class' => 'button-color1 button-size1', 'id' => 'addtocart')); ?>
            </div>
        </div>
