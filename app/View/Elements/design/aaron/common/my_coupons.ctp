...
<div class="title-bar">My Coupon</div>
    ...
    <div class="form-section form-padding">
        ...
        <div class=" table hc vc bgcolor_white">
            ...
            <div class="form-group row">
                <?php echo $this->Form->create('Coupon', array('url' => array('controller' => 'coupons', 'action' => 'myCoupons'), 'id' => 'AdminId', 'type' => 'post', 'class' => 'p10 clearfix')); ?>
                ...
                <div class="col-sm-2 col-xs-6 hc vc"><?php echo $this->Html->link('Clear', array('controller' => 'coupons', 'action' => 'myCoupons', 'clear'), array('class' => 'uc f16 button bgcolor_theme1 w100p')); ?></div>
            </div>
