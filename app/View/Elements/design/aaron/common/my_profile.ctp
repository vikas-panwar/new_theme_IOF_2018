...
if (DESIGN == 3) {
    ...
    <div class="main-container">
        ...
        <div class="layout-container pages"><!-- profile -->
            ...
            <div class="form hc vc">
                ...
                ?>
                    ...
                    <div class="form-group row"><label class="col-sm-3 col-xs-3 col-form-label">Mobile Phone<em>*</em></label>
                        <div class="col-sm-3 col-xs-3"><?php echo $this->Form->input('User.country_code_id', array('type' => 'select', 'options' => $countryCode, 'value' => $this->request->data['CountryCode']['id'], 'class' => 'country-code form-control', 'label' => false, 'div' => false));?></div>
                    ...
                    <div class="form-group row"><label class="col-sm-3 col-form-label">DOB</label>
                    ...
                    <div class="form-group row"><label class="col-sm-3 col-form-label">City<em>*</em></label>
                        <div class="col-sm-9"><?php echo $this->Form->input('User.city_id', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'Select City'));?></div></div>  

                    <div class="form-group row"><label class="col-sm-3 col-form-label">State<em>*</em></label>
                        <div class="col-sm-9"><?php echo $this->Form->input('User.state_id', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'Select State'));?></div></div>  

                    <div class="form-group row"><label class="col-sm-3 col-form-label">Zip Code<em>*</em></label>
                        <div class="col-sm-9"><?php echo $this->Form->input('User.zip_id', array('type' => 'text', 'class' => 'form-control', 'label' => false, 'div' => false, 'empty' => 'Select Zip'));?></div></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                                <ul class="profile-notifications">
                                    ...
                                    <?php } else { ?>
                                        <div>                                        
                                            <input type="checkbox" id="email_note"  name="data[User][is_emailnotification]"  /> 
                                            <label for="email_note">Opt for email notification</label>
                                        </div>    
                                    <?php } ?>
                                    ...
                                    <?php } else { ?>
                                        <div>                                       
                                            <input type="checkbox" id="sms_note"  name="data[User][is_smsnotification]"  />
                                            <label for="sms_note">Opt for SMS notification</label>
                                        </div>  
                                    <?php } ?>
                                    <div>
                        ...
                        <div id="change_password_block">
                            ...
                            <div class="form-group row"><label class="col-sm-3 col-form-label">Old Password <em>*</em></label>
                                <div class="col-sm-9"><?php echo $this->Form->input('User.oldpassword', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'Old Password', 'maxlength' => '20', 'label' => false));?></div></div>

                            <div class="form-group row"><label class="col-sm-3 col-form-label">New Password <em>*</em></label>
                                <div class="col-sm-9"><?php echo $this->Form->input('User.password', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'New Password', 'maxlength' => '20', 'label' => false, 'value' => ''));?></div></div>
                                
                            <div class="form-group row"><label class="col-sm-3 col-form-label">Confirm Password<em>*</em></label>
                                <div class="col-sm-9"><?php echo $this->Form->input('User.password_match', array('type' => 'password', 'class' => 'form-control', 'placeholder' => 'Confirm Password', 'maxlength' => '20', 'label' => false));?></div></div>
                    ...
                    <div class="hc vc tc">
                        <?php echo $this->Form->button('Update', array('type' => 'submit', 'class' => 'hc uc button f18 bgcolor_focus w260'));?>
                        <?php echo $this->Form->button('Cancel', array('type' => 'button', 'onclick' => "window.location.href='/users/myDeliveryAddress/$encrypted_storeId/$encrypted_merchantId'", 'class' => 'hc uc button f18 bgcolor_default w260'));?>                          
                    </div>
