...
<div class="main-container">
    ...
    <div class="layout-container pages">
        ...
        <div class="form hc vc">
            ...
            <div class="form-group row"><label class="col-sm-3 col-form-label">Address <em>*</em></label>
            <div class="col-sm-9"><?php
            ...
            <div class="col-sm-3 col-xs-3"><?php echo $this->Form->input('DeliveryAddress.country_code_id', array('type' => 'select', 'options' => $countryCode, 'value' => $this->request->data['CountryCode']['id'], 'class' => 'country-code form-control', 'label' => false, 'div' => false)); ?></div>
            <div class="col-sm-6 col-xs-6"><?php echo $this->Form->input('DeliveryAddress.phone', array('data-mask' => 'mobileNo', 'type' => 'text', 'class' => 'phone form-control', 'placeholder' => 'Phone Number', 'label' => false, 'div' => false, 'required' => true)); ?>
            ...
            <div class="col-sm-9">
                <div class="">
                    ...
                    echo $this->Form->checkbox('DeliveryAddress.default', array('checked' => $checked,'id'=>'news'));
                    ?> &nbsp;
                    <label for="news">Default address</label>
                </div>
            </div>
