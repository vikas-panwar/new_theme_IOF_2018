...
<html>
    <head>
        ...
        if (!empty($store_data_app['Store']['store_theme_id']) && $store_data_app['Store']['store_theme_id'] == 11) {
            ...
            echo $this->Html->css('aaron/h-master');
...
?>
    ...
    <body class="<?php echo KEYWORD . " " . SELECTEDTHEME; ?>">
        ...
        <div class="modal fade add-info item-modal" id="item-modal" tabindex="-1" data-focus-on="input:first" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;" >
        </div>
